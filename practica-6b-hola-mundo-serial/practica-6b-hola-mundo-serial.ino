...
void setup() {
  ...
  Serial.println(F("-->              PROGRAMA HOLA MUNDO                <--"));
  Serial.println();

  // probamos a mandar mas texto con print y println
  Serial.print(F("Esto comienza una linea de texto... "));
  Serial.print(F("segimos en la misma... "));
  Serial.println(F("terminamos la linea de texto"));
  Serial.println(F("Ahora estamos en una nueva linea"));
  Serial.println();

  // prueba de impresión de variables
  Serial.println(F("Ahora probemos a imprimir el valor de algunas variables:"));
